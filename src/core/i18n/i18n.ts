...
import { GENERATED_TRANSLATIONS } from '../../i18n/resources.generated';
import { RUNTIME_TRANSLATION_OVERRIDES } from '../../i18n/runtimeOverrides';
...
export function translate(
  ...
  if (
    ...
    console.warn(`[QVEX i18n] Missing translation key: ${language}.${path}`);
  }
