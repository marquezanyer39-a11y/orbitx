...
const EN: RewardsPoolCopy = {
  ...
  providerLabel: 'QVEX Pool',
  spreadLabel: 'QVEX fee',
  ...
  processedByOrbitX: 'Processed inside QVEX.',
};
...
const ES: RewardsPoolCopy = {
  ...
  headerBody: 'Participa y gana según tu aporte',
  headerBack: 'Volver',
  positionTitle: 'TU POSICIÓN EN EL POOL',
  realContribution: 'Aporte real',
  rankingContribution: 'Aporte ranking',
  positionLabel: 'Posición',
  estimatedReward: 'Ganancia estimada',
  rankingNote: 'Ranking usa máx. $10. Tu aporte completo sí cuenta.',
  rewardsTitle: 'Estructura de premios',
  rewardsExtra: '+ reparto proporcional del restante',
  ...
  distributingBanner: 'Estamos calculando la distribución final.',
  ...
  modalBody: 'Envías un único aporte crypto y aseguras tu participación final.',
  assetSelectorLabel: 'Moneda',
  amountLabel: 'Monto',
  usdEquivalent: 'Equivalente USD',
  estimatedPosition: 'Posición estimada',
  confirmLabel: 'Confirmar participación',
  confirmPreviewTitle: 'Vista previa',
  confirmExecuteTitle: 'Enviando transacción',
  providerLabel: 'Pool QVEX',
  spreadLabel: 'Fee QVEX',
  etaLabel: 'Tiempo estimado',
  availabilityLabel: 'Disponibilidad',
  recentTitle: 'Referencias recientes',
  favoritesTitle: 'Favoritos',
  actionPreview: 'Previsualizar participación',
  actionExecute: 'Confirmar participación',
  ...
  minMaxLabel: 'Min $1 · Max $50',
  txPending: 'Esperando confirmación...',
  txSuccess: 'Participación confirmada',
  duplicateError: 'Solo puedes participar una vez en este pool.',
  poolClosedError: 'Este pool ya está cerrado.',
  noBalanceError: 'No tienes saldo suficiente en este activo.',
  invalidAmountError: 'Ingresa un monto válido.',
  belowMinimumError: 'El aporte mínimo es $1.',
  aboveMaximumError: 'El aporte máximo es $50.',
  unavailablePair: 'Este activo no está disponible por ahora.',
  thisIsYou: 'TÚ ESTÁS AQUÍ',
  projectedBadge: 'ESTIMADO',
  oneParticipationRule: 'Una sola participación por usuario.',
  processedByOrbitX: 'Procesado dentro de QVEX.',
};
