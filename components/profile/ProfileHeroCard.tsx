...
const styles = StyleSheet.create({
  ...
  glow: {
    ...
    height: 172,
    borderRadius: 86,
    backgroundColor: withProfileAlpha(PROFILE_THEME.colors.primary, 0.12),
  },
  avatarShell: {
    position: 'relative',
  },
  avatarRing: {
    ...
    borderWidth: 1,
    borderColor: withProfileAlpha(PROFILE_THEME.colors.primary, 0.5),
  },
  avatar: {
    width: '100%',
    height: '100%',
  ...
  editButton: {
    ...
    borderWidth: 2,
    borderColor: PROFILE_THEME.colors.surfaceLow,
  },
  pressed: {
    opacity: 0.84,
  ...
  idPill: {
    ...
    borderWidth: 1,
    borderColor: withProfileAlpha(PROFILE_THEME.colors.outline, 0.06),
  },
  idText: {
    color: PROFILE_THEME.colors.textSecondary,
    fontFamily: PROFILE_THEME.typography.bodyMedium,
  ...
  statusChip: {
    ...
    borderWidth: 1,
    borderColor: withProfileAlpha(PROFILE_THEME.colors.outline, 0.08),
  },
  statusDot: {
    width: 8,
    height: 8,
