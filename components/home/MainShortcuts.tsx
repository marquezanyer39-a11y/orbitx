...
const styles = StyleSheet.create({
  row: {
    ...
    borderWidth: 1,
    borderColor: withOpacity(ORBITX_THEME.colors.border, 0.07),
    backgroundColor: withOpacity(ORBITX_THEME.colors.surfaceSoft, 0.38),
    overflow: 'hidden',
  },
  item: {
    flex: 1,
  ...
  divider: {
    ...
    bottom: 16,
    width: 1,
    backgroundColor: withOpacity(ORBITX_THEME.colors.border, 0.12),
  },
  pressed: {
    opacity: 0.78,
  },
